...
/
UPDATE EMP SET SAL = (SELECT CASE
WHEN DEPT.LOC = 'NEWYORK' AND EMP.COMM IS NOT NULL THEN EMP. SAL * 1.05
WHEN DEPT.LOC = 'NEWYORK' AND EMP.COMM IS NULL THEN EMP. SAL * 1.07
WHEN DEPT.LOC <> 'NEWYORK' AND EMP.COMM IS NOT NULL THEN EMP. SAL *1.08
ELSE EMP.SAL * 1.095
END FROM DEPT
